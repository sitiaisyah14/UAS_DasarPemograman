...
public class TugasPerbankan {
    public static void main(String[] args) {
        ...
        String [][] dataNasabah = {
            ...
            {"Aprilia","\t7710-01-010918-53-9","BRI Junior","Rp. 800.000"},
        };
        ...
        if (fitur.equalsIgnoreCase("Mendaftar")){
            ...
            System.out.println("========= Isi PIN (6 digit) dan simpan privasi PIN Anda ===========");
...
// Untuk fitur yang ke 2        
    ...
    static void jumlahPin(int a){
        ...
        a = 0;
        if(a < 6){ 
            System.out.println("     ***Isi PIN Anda minimal 6 digit***");
